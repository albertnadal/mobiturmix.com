...
*/
		...
		switch($tipus)
		{
			...
			case VIDEO:		$item = 'vídeo'; $domini = 'video.mobiturmix.com'; break;
			...
			case ANIMATION:		$item = 'animado'; $domini = 'anima.mobiturmix.com'; break;
                ...
                if($a_amic)
                {
                        $subjecte = "Un amigo te recomienda este $item para el móvil";
                        $missatge = "
                                <p>Hola,</p>
                                <p>un amigo tuyo ha subido un $item a <b><tt>MobiTurmix</tt></b> y desea compartirlo contigo.</p>

                                <p>Puedes ver una previsualización online del $item a trabés de <a href=\"http://$domini/info.php?c=$codi_contingut\">este enlace</a>, así como los pasos que deves seguir si deseas descargarte el $item a tu móvil.</p>
...
Estamos en continuo trabajo para mejorar y ofrecerte próximas novedades.</p>
                ...
                else
                {
                        ...
                        $mesos = array( 'Enero',
                                        ...
                                        'Diciembre');
                        $mes = $mesos[$dia_mes];
                        $subjecte = "Tu $item ya está listo para descargar";
                        $missatge = "
                                <p>Hola,</p>

                                <p>Nos alegra comunicarte que ya tenemos preparado el $item que subiste a <b><tt>MobiTurmix</tt></b> el día $dia de $mes a las $hora:$minut.</p>

                                <p>Puedes ver una previsualización online de tu $item a trabés de <a href=\"http://$domini/info.php?c=$codi_contingut\">este enlace</a>, así como los pasos que deves seguir para poder descargarte el $item a tu móvil.</p>
...
<div>
        <div style=\"padding: 5px; background-color: rgb(160, 207, 244);\">
                <h1 style=\"color: rgb(255, 255, 255);\">&nbsp;<a style=\"font-size: 24px;color: rgb(255, 255, 255);\" href=\"http://www.mobiturmix.com\" title=\"MobiTurmix\" border=\"0\">MobiTurmix</a> &nbsp;<span style=\"font-size: 14px;\">Tu contenido multimedia, en tu móvil.</span></h1>
        </div>
