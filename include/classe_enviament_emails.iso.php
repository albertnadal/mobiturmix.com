...
//		$mail->isHTML(true);
		$mail->AddEmbeddedImage('preview.gif', 'preview', 'preview.gif');
...
<div>
        <div style=\"padding: 5px; background-color: rgb(160, 207, 244);\">
                <h1 style=\"color: rgb(255, 255, 255);\">&nbsp;<a style=\"font-size: 24px;color: rgb(255, 255, 255);\" href=\"http://www.mobiturmix.com\" title=\"MobiTurmix\" border=\"0\">MobiTurmix</a> &nbsp;<span style=\"font-size: 14px;\">Tu contenido multimedia, en tu mï¿½vil</span></h1>
        </div>
