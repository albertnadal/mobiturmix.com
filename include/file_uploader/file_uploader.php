...
define("MAX_FILE_SIZE", 16777216); //16MB tamany m�im fitxer per defecte
...
class file_uploader extends file_upload
{
        ...
        function extra_text($msg_num)
        {
                switch ($this->language)
                {
                        case "cat":
                                ...
                                $extra_msg[2] = "Has probat de puijar fitxers amb extensions ".$this->wrong_extensions.", nom� les segents extensions estan permeses: <b>".$this->ext_string."</b>";
                                $extra_msg[3] = "Escull almenys un fitxer.";
                                $extra_msg[4] = "Escull el(s) fitxer(s) a penjar.";
                                $extra_msg[5] = "Has probat de puijar el fitxer <b>".$this->bad_filenames."</b> que cont�car�ters no v�ids al nom.";
                                $extra_msg[6] = "Fitxer";
                                $extra_msg[7] = "Adjuntar m� fitxers...";
                        break;
                        case "es":
                                $extra_msg[1] = "Error: <b>".$this->the_file."</b>";
                                ...
                                $extra_msg[5] = "Has probado de subir el fichero <b>".$this->bad_filenames."</b> que contiene car�teres no v�idos al nombre.";
                                $extra_msg[6] = "Fichero";
                                $extra_msg[7] = "Adjuntar m� ficheros...";
                        break;
                        default:
        ...
        {
                print "<form action=\"#\" method=\"post\" name=\"upload_form\" enctype=\"multipart/form-data\"><input name=\"upload\" type=\"file\"/></form>";
        }
