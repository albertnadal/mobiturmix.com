...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="798" height="486" align="left" valign="top"><p class="Estilo1"><span class="Estilo10">Tenemos tres formas para que puedas descargar el contenido a tu m&oacute;vil.</span>


      <ol>
        <li class="Estilo14"> <strong>Gratuitamente</strong> mediante la descarga del fichero.
          <ol type="a">
	    <li>Escoje tu marca y modelo de m&oacute;vil de nuestro listado.</li>
            <li>Desc&aacute;rgate el fichero, simplemente clica encima del enlace <strong>Download now!</strong>.</li>
            <li>Mediante un <strong>cable</strong> o por <strong>bluetooth</strong> copia el fichero del PC a tu m&oacute;vil, y ya es tuyo!<br />
              <center><img src="sample3.jpg"></center>
            </li>
          </ol>
        </li>
        <li class="Estilo14"> <strong>Gratuitamente</strong> mediante descarga directa por enlace <strong>WAP</strong>.
          <ol type="a">
        ...
        <li class="Estilo14">C&oacute;modamente mediante el env&iacute;o de un <strong>SMS</strong> <span class="Estilo17">(1,2 euros + i.v.a)</span>.
          <ol type="a">
            <li>Escribe la palabra <strong>etm</strong> seguido de un espacio y el c&oacute;digo del contenido en un <strong>SMS</strong>.<br />
            </li>
