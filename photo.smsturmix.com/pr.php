...
if($res!=null)
{
  ...
  switch($es_front)
  {
	case 4: $imatge_polaroid = file_get_contents('/var/www/html/www.smsturmix.com/polaroid.jpg');
	case 3:	if($es_front==3) $imatge_polaroid = file_get_contents('/var/www/html/www.smsturmix.com/polaroid_red.jpg');
